...
export interface Anchor {
  readonly x: number;
  readonly y: number | { readonly bottom: number; readonly top: number };
}
...
export interface Props
  extends CommonProps.Children,
    CommonProps.Closeable,
...
const {
  MeasuredBalloon: {
    Background: { strokeWidth, svgPadding, triangleHeight }
  },
  margin,
  padding
} = consts.Balloon;
