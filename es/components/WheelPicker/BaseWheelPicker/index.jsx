...
export default memo("BaseWheelPicker", function BaseWheelPicker({ color, customRef, disabled, largeSwipeSize, largeSwipeStopInterval, onChange, onOverflow, onScrollEnd = fn.noop, onScrollStart = fn.noop, options, smallSwipeSize, smallSwipeStopInterval, tick, value }) {
