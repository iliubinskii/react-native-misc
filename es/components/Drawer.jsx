...
export default memo("Drawer", ({ children, customRef, dragToOpen = false, drawerContents, height, onClosed = fn.noop, onOpened = fn.noop, openRef, position, width // eslint-disable-next-line sonarjs/cognitive-complexity -- Ok
 }) => {
