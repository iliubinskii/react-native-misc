...
export declare enum MenuAnchorPosition {
    bottom = "bottom",
    top = "top"
}
...
export declare enum TextInputAutoCapitalize {
    characters = "characters",
    none = "none",
    sentences = "sentences",
    words = "words"
}
export declare enum TextInputAutoComplete {
    email = "email",
    name = "name",
...
export declare enum TextInputMode {
    flat = "flat",
    outlined = "outlined"
}
export declare enum TextInputKeyboardType {
...
export declare enum TextInputTextContentType {
...
export declare enum ToggleButtonStatus {
    checked = "checked",
    unchecked = "unchecked"
}
...
export interface MD3ColorsExtended extends MD3ColorsExtendedBasic, MD3ColorsExtendedComponents {
}
...
//# sourceMappingURL=react-native-paper.d.ts.map