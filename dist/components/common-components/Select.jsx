...
function ({ PlaceholderIcon, backgroundColor, caption, foregroundColor, maxItems = defaultMaxItems, onChange = typescript_misc_1.fn.noop, onReset = typescript_misc_1.fn.noop, onSelect = typescript_misc_1.fn.noop, options, placeholder = defaultPlaceholder, resettable = false, rowStyle, style, value }) {
    ...
    const ref = React.useRef((0, typescript_misc_1.neverDemand)());
