...
exports.default = (0, react_misc_1.memo)("TextInputWithRightIcon", ({ Icon, iconDisabled, onIconPress, ...props }) => {
    const right = React.useCallback(({ color, size }) => (<common_common_components_1.IconButton Icon={Icon} disabled={iconDisabled} iconColor={color} onPress={onIconPress} size={size} style={{ margin: 0 }}/>), [Icon, iconDisabled, onIconPress]);
