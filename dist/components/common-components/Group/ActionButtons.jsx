...
exports.default = (0, react_misc_1.memo)("ActionButtons", ({ start = false, style, ...props }) => (<common_common_components_1.Row style={[
        {
            gap: exports.gap,
...
_a = core_1.consts.Group.ActionButtons, exports.gap = _a.gap, exports.marginBottom = _a.marginBottom, exports.marginHorizontal = _a.marginHorizontal;
