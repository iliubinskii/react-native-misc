...
exports.default = (0, react_misc_1.memo)("EventsCalendar", function EventsCalendar({ borderBottom = false, borderEnd = false, borderStart = false, borderTop = false, getKey, getLabel, getTextStyle, isFeatured, items, month, onDayPress, onMonthChange, style, weekStartsOn, workweekStartsOn }) {
